...
//go:generate minimock -i gitlab.ozon.dev/cyxrop/homework-2/internal/app/service/user.MessageSender -o ./internal/app/service/user/message_sender_mock_test.go -n MessageSenderMock
...
type MessageSenderMock struct {
	...
	funcSendMessage          func(i1 int64, s1 string) (err error)
	inspectFuncSendMessage   func(i1 int64, s1 string)
...
func (mmSendMessage *mMessageSenderMockSendMessage) Expect(i1 int64, s1 string) *mMessageSenderMockSendMessage {
	...
	mmSendMessage.defaultExpectation.params = &MessageSenderMockSendMessageParams{i1, s1}
...
func (mmSendMessage *mMessageSenderMockSendMessage) Inspect(f func(i1 int64, s1 string)) *mMessageSenderMockSendMessage {
...
func (mmSendMessage *mMessageSenderMockSendMessage) Set(f func(i1 int64, s1 string) (err error)) *MessageSenderMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mMessageSenderMockSendMessage) When(i1 int64, s1 string) *MessageSenderMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("MessageSenderMock.SendMessage mock is already set by Set")
	}
	...
	expectation := &MessageSenderMockSendMessageExpectation{
		...
		params: &MessageSenderMockSendMessageParams{i1, s1},
	}
...
func (mmSendMessage *MessageSenderMock) SendMessage(i1 int64, s1 string) (err error) {
	mm_atomic.AddUint64(&mmSendMessage.beforeSendMessageCounter, 1)
	defer mm_atomic.AddUint64(&mmSendMessage.afterSendMessageCounter, 1)

	if mmSendMessage.inspectFuncSendMessage != nil {
		mmSendMessage.inspectFuncSendMessage(i1, s1)
	}

	mm_params := &MessageSenderMockSendMessageParams{i1, s1}
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		mm_got := MessageSenderMockSendMessageParams{i1, s1}
	...
	if mmSendMessage.funcSendMessage != nil {
		return mmSendMessage.funcSendMessage(i1, s1)
	}
	mmSendMessage.t.Fatalf("Unexpected call to MessageSenderMock.SendMessage. %v %v", i1, s1)
	return
}
